...
Version  : 2.0.2
Release  : 47
URL      : https://github.com/firewalld/firewalld/releases/download/v2.0.2/firewalld-2.0.2.tar.bz2
Source0  : https://github.com/firewalld/firewalld/releases/download/v2.0.2/firewalld-2.0.2.tar.bz2
...
%prep
%setup -q -n firewalld-2.0.2
cd %{_builddir}/firewalld-2.0.2
pushd ..
cp -a firewalld-2.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701955415
