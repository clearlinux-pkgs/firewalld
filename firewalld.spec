...
Version  : 1.2.2
Release  : 38
URL      : https://github.com/firewalld/firewalld/releases/download/v1.2.2/firewalld-1.2.2.tar.gz
Source0  : https://github.com/firewalld/firewalld/releases/download/v1.2.2/firewalld-1.2.2.tar.gz
...
%prep
%setup -q -n firewalld-1.2.2
cd %{_builddir}/firewalld-1.2.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671485606
