...
Version  : 0.6.3
Release  : 1
URL      : https://github.com/firewalld/firewalld/archive/v0.6.3.tar.gz
Source0  : https://github.com/firewalld/firewalld/archive/v0.6.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1550099879
