...
Version  : 2.0.1
Release  : 45
URL      : https://github.com/firewalld/firewalld/releases/download/v2.0.1/firewalld-2.0.1.tar.bz2
Source0  : https://github.com/firewalld/firewalld/releases/download/v2.0.1/firewalld-2.0.1.tar.bz2
...
%prep
%setup -q -n firewalld-2.0.1
cd %{_builddir}/firewalld-2.0.1
pushd ..
cp -a firewalld-2.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697574630
