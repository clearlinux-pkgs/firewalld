...
Version  : 1.0.3
Release  : 30
URL      : https://github.com/firewalld/firewalld/releases/download/v1.0.3/firewalld-1.0.3.tar.gz
Source0  : https://github.com/firewalld/firewalld/releases/download/v1.0.3/firewalld-1.0.3.tar.gz
...
%prep
%setup -q -n firewalld-1.0.3
cd %{_builddir}/firewalld-1.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641922183
...
cp %{_builddir}/firewalld-1.0.3/COPYING %{buildroot}/usr/share/package-licenses/firewalld/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
%find_lang firewalld
