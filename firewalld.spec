...
Source0  : https://github.com/firewalld/firewalld/releases/download/v2.1.0/firewalld-2.1.0.tar.bz2
...
%prep
%setup -q -n firewalld-2.1.0
cd %{_builddir}/firewalld-2.1.0
pushd ..
cp -a firewalld-2.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704726423
