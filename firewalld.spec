...
Source0  : https://github.com/firewalld/firewalld/releases/download/v1.3.0/firewalld-1.3.0.tar.gz
...
%prep
%setup -q -n firewalld-1.3.0
cd %{_builddir}/firewalld-1.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672967276
